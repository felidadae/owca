...
.. csv-table::
	...
	"platform_pmm_bandwidth_reads", "Persistent memory module number of reads.", "auto (enable_perf_uncore)", "numeric",  "counter", "perf subsystem with cgroups", "socket, pmu_type"
	"platform_pmm_bandwidth_writes", "Persistent memory module number of writes.", "auto (enable_perf_uncore)", "numeric",  "counter", "perf subsystem with cgroups", "socket, pmu_type"
	"platform_cas_count_reads", "Column adress select number of reads", "auto (enable_perf_uncore)", "numeric",  "counter", "perf subsystem with cgroups", "socket, pmu_type"
	"platform_cas_count_writes", "Column adress select number of writes", "auto (enable_perf_uncore)", "numeric",  "counter", "perf subsystem with cgroups", "socket, pmu_type"
	"platform_upi_rxl_flits", "TBD", "auto (enable_perf_uncore)", "numeric",  "counter", "perf subsystem with cgroups", "socket, pmu_type"
	"platform_upi_txl_flits", "TBD", "auto (enable_perf_uncore)", "numeric",  "counter", "perf subsystem with cgroups", "socket, pmu_type"
